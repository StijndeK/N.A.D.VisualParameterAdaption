    ...
    */
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            // start movestate
            if (Input.mousePosition[0] <= cords[0] + 10 && Input.mousePosition[0] >= cords[0] - 10 && Input.mousePosition[1] <= cords[1] + 10 && Input.mousePosition[1] >= cords[1] - 10)
            {
                moveState = true;
            }
        }
